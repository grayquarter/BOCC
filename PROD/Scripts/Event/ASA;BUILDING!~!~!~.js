...
// if (!appMatch('Building/POS/*/*')) {
// 	if(isDRIexpir(capIDString)==true) addAppCondition('CC PERMIT', 'Applied', 'DRI Notice', 'The permit being applied for may be within an expired DRI. Further review is needed.', 'Notice');
// 	}

// DISABLED: ASA:Building/*/*/*:15
// if (!appMatch('Building/POS/*/*')) {
// 	if (isDRIexpir(capIDString) == true) addStdCondition('CC PERMIT', 'DRI Notice');
// 	}
